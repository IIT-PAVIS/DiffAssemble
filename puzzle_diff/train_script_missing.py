...
def main(
    ...
    train_dt, test_dt, puzzle_sizes = get_dataset_missing_pieces(
        dataset=dataset, puzzle_sizes=puzzle_sizes, missing_pieces_perc=missing_pieces_perc
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("-missing_pieces_perc", type=int, default=10)
    ...
    main(
        ...
        missing_pieces_perc=args.missing_pieces_perc
    )
