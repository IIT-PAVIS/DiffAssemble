...
class Eff_GAT_Discrete(nn.Module):
    """
    ...
    def __init__(self, steps, input_channels, output_channels) -> None:
        super().__init__()
    ...
    def forward_with_feats(
        ...
        # GNN
        feats, attentions = self.gnn_backbone(x=combined_feats, edge_index=edge_index)
