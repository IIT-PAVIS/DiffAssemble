...
class PointNetEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.global_feat:
            ...
            return pointfeat #torch.cat([x, pointfeat], 1) #, trans, trans_feat



class PretrainedPointnet(nn.Module):
    def __init__(self, channels=3, num_class=1):
        super().__init__()
        self.k = num_class
...
class PointNetPlus(nn.Module):
    ...
    def forward(self, xyz):
        ...
        # FC layers
        #feat = F.relu(self.bn1(self.conv1(l3_points)))
        #x = self.drop1(feat)
        #x = self.conv2(x)
