...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.linear1 = nn.Linear(128*4*block.expansion*32, 544)
        self.linear2 = nn.Linear(256*4*block.expansion*8, 544)
    ...
    def forward(self, x):
        ...
        out4 = self.layer4(out3)#.view(out.size(0), -1)
        ...
        out3 = self.linear1(out3.view(out3.size(0), -1))
        out4 = self.linear2(out4.view(out4.size(0), -1))
